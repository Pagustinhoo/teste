...
const Home: React.FC = () => {
  ...
  // IMÓVEIS EM DESTAQUE (exatamente os que você pediu, sem ID 1)
const featuredProperties = [
  properties.find(p => p.id === 10),
  properties.find(p => p.id === 2),
  properties.find(p => p.id === 3),
  properties.find(p => p.id === 4),
  properties.find(p => p.id === 5),
]
