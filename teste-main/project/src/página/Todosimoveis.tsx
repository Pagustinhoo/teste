// src/pages/TodosImoveis.tsx   (ou AllProperties.tsx – o nome que você usa)
          ...
          {properties.map((property: Property) => {
            ...
            return (
              ...
              >
                ...
                {/* CONTEÚDO DO CARD */}
                <div className="p-6">
                  {/* TÍTULO = TIPO DO IMÓVEL (nunca mais categoria) */}
                  <h3 className="text-xl font-bold text-gray-800 mb-2 line-clamp-2">
                    <Link to={`/imoveis/${property.id}`} className="hover:text-blue-600 transition">
                      {property.tipo}
                    </Link>
                  </h3>
