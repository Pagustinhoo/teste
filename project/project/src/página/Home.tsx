...
const Home: React.FC = () => {
  ...
  {contactOpen && (
    <div className="absolute left-1/2 -translate-x-1/2 mt-2 w-56 bg-white text-gray-800 rounded-xl shadow-lg border border-gray-200 z-50">
      <a
        href="https://wa.me/5545920029986"
        target="_blank"
        className="block px-4 py-3 hover:bg-gray-100 rounded-t-xl"
      ...
      <a
        ...
        className="block px-4 py-3 hover:bg-gray-100 rounded-b-xl"
        onClick={() => setContactOpen(false)}
      >
        E-mail
      </a>
