...
import { MapPin, Star, TrendingUp, HomeIcon, Users, Building, Award, Search } from 'lucide-react';
...
const Home: React.FC = () => {
  ...
  const featuredProperties = properties.slice(0, 6).map(property => ({
    ...
    area: property.area,
    image: `https://source.unsplash.com/800x600/?house,${property.tipo}` // Placeholder image
  }));
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-start justify-center bg-white rounded-lg shadow-md p-6 text-left">
              <stats[0].icon className="w-12 h-12 text-blue-600 mb-4" />
              <div className="text-2xl font-bold text-gray-800 mb-2">{stats[0].value}</div>
              <div className="text-gray-600">{stats[0].label}</div>
            </div>
            <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-md p-6 text-center">
              <stats[1].icon className="w-12 h-12 text-blue-600 mb-4" />
              <div className="text-2xl font-bold text-gray-800 mb-2">{stats[1].value}</div>
              <div className="text-gray-600">{stats[1].label}</div>
            </div>
            <div className="flex flex-col items-end justify-center bg-white rounded-lg shadow-md p-6 text-right">
              <stats[2].icon className="w-12 h-12 text-blue-600 mb-4" />
              <div className="text-2xl font-bold text-gray-800 mb-2">{stats[2].value}</div>
